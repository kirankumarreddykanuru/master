Webruntime.moduleRegistry.define('c/apexImperativeMethod', ['lwc', 'lightning/configProvider', 'force/lds', 'wire-service'], function (lwc, configProvider, lds, wireService) { 'use strict';
    ...
    * */
    ...
    function tmpl$m($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 6,
        on: {
          "click": _m1 || ($ctx._m1 = api_bind($cmp.handleLoad))
        }
      }, [])]), api_element("div", {
        classMap: {
          "slds-m-around_small": true
        ...
        key: 7
      }, api_iterator($cmp.records, function (item) {
        return api_element("p", {
          key: api_key(9, item.Id)
        }, [api_dynamic(item.Subject)]);
      })), api_element("div", {
        classMap: {
          "slds-m-around_small": true
        },
        ...
        key: 12
      }, [api_text("There were error")]) : null])])];
    }

    var _tmpl$l = lwc.registerTemplate(tmpl$m);
    tmpl$m.stylesheets = [];
    tmpl$m.stylesheetTokens = {
      hostAttribute: "lwc-apexImperativeMethod_apexImperativeMethod-host",
      shadowAttribute: "lwc-apexImperativeMethod_apexImperativeMethod"
    };

    const apexInvoker = lds.getApexInvoker("", "CaseController", "getAllCases", false);
    wireService.register(apexInvoker, lds.generateGetApexWireAdapter("", "CaseController", "getAllCases", false));

    class ApexImperativeMethod extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.subject = void 0;
        this.records = void 0;
    ...
    lwc.registerDecorators(ApexImperativeMethod, {
      track: {
        subject: 1,
        records: 1,
        error: 1
    ...
    var apexImperativeMethod = lwc.registerComponent(ApexImperativeMethod, {
      tmpl: _tmpl$l
    });

    return apexImperativeMethod;
