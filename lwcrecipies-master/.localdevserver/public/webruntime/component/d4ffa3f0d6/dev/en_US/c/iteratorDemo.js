Webruntime.moduleRegistry.define('c/iteratorDemo', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".list-first" + shadowSelector + " {border-top: 1px solid black;padding-top: 5px;}\n.list-last" + shadowSelector + " {border-bottom: 1px solid black;padding-bottom: 5px;}\n";
    }
    ...
    **/
    ...
    function tmpl$3($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 3
      }, api_iterator($cmp.contacts, function (item, index) {
        return api_element("p", {
          classMap: {
            "slds-m-around_small": true
          },
          key: api_key(5, item.Id)
        }, [api_dynamic(index), api_text(" - "), api_dynamic(item.Name), api_text(" \xA0 "), api_dynamic(item.Email)]);
      })), api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Iterator Demo",
          "iconName": "standard:contact"
        ...
        key: 6
      }, api_iterator($cmp.contacts, function (itValue, itIndex, itFirst, itLast) {
        return api_element("li", {
          ...
          key: api_key(8, itValue.Id)
        }, [itFirst ? api_element("div", {
          classMap: {
            "list-first": true
          },
          key: 9
        }, []) : null, api_dynamic(itValue.Name), api_text(" \xA0 "), api_dynamic(itValue.Email), itLast ? api_element("div", {
          classMap: {
            "list-last": true
          },
          key: 10
    ...
    tmpl$3.stylesheetTokens = {
      hostAttribute: "lwc-iteratorDemo_iteratorDemo-host",
      shadowAttribute: "lwc-iteratorDemo_iteratorDemo"
    };

    class IteratorDemo extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.contacts = [{
          Id: 1,
        ...
        this.myMap = new Map([["A", 1], ["B", 2]]);
      }

    }

    var iteratorDemo = lwc.registerComponent(IteratorDemo, {
      tmpl: _tmpl$4
    });
