Webruntime.moduleRegistry.define('c/beerList', ['lwc', 'lightning/configProvider', 'force/lds', 'wire-service', 'webruntime/configProvider', 'lightning/navigation'], function (lwc, configProvider, lds, wireService, configProvider$1, navigation) { 'use strict';
    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        props: {
          ...
          "label": "Beer Search",
          "placeholder": "Type here to search beer records"
        },
        key: 4,
        on: {
    ...
    tmpl$l.stylesheetTokens = {
      hostAttribute: "lwc-beerSearch_beerSearch-host",
      shadowAttribute: "lwc-beerSearch_beerSearch"
    };

    class BeerSearch extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(BeerSearch, {
      track: {
        searchValue: 1
      }
    });

    var _cBeerSearch = lwc.registerComponent(BeerSearch, {
      tmpl: _tmpl$k
    });
    ...
    function tmpl$n($api, $cmp, $slotset, $ctx) {
      ...
      return [$cmp.beerRecord ? api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": $cmp.beerRecord.Name,
        ...
        key: 8
      }, [api_text("Beer Id : ")]), api_text(" "), api_dynamic($cmp.beerRecord.Id__c), api_text(" "), api_element("br", {
        key: 9
      }, []), api_element("strong", {
        key: 10
      }, [api_text("Alcohal % : ")]), api_text(" "), api_dynamic($cmp.beerRecord.Alcohol__c), api_text(" "), api_element("br", {
        key: 11
      }, []), api_element("strong", {
        key: 12
      }, [api_text("Price : ")]), api_text(" "), api_dynamic($cmp.beerRecord.Price__c), api_text(" "), api_element("br", {
        key: 13
      }, []), api_element("strong", {
        key: 14
      }, [api_text("Brewery Name : ")]), api_text(" "), api_dynamic($cmp.beerRecord.brewery_Name__c)]), api_element("p", {
        classMap: {
          "slds-m-around_small": true
        },
        key: 15
        ...
        key: 16,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.handleAddToCart))
        }
      }, [])])])]) : null];
    }
    ...
    tmpl$n.stylesheetTokens = {
      hostAttribute: "lwc-beerTile_beerTile-host",
      shadowAttribute: "lwc-beerTile_beerTile"
    };

    class BeerTile extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.beerRecord = void 0;
      }
    ...
    lwc.registerDecorators(BeerTile, {
      publicProps: {
        beerRecord: {
          config: 0
        }
    ...
    var _cBeerTile = lwc.registerComponent(BeerTile, {
      tmpl: _tmpl$m
    });
    ...
    function tmpl$o($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 4
      }, [api_dynamic($cmp.itemsinCart)])]), api_element("div", {
        styleMap: {
          "marginLeft": "1300px"
        },
        key: 5
        ...
        key: 6,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.navigateToCartDetail))
        }
      }, [api_element("img", {
        attrs: {
          "src": $cmp.cart,
        ...
        key: 8
      }, [api_custom_element("c-beer-search", _cBeerSearch, {
        key: 9,
        on: {
          "search": _m1 || ($ctx._m1 = api_bind($cmp.handleEvent))
        }
      }, [])]), api_element("div", {
        classMap: {
          "slds-m-left_small": true,
        ...
        key: 10
      }, [$cmp.beerRecords ? api_element("div", {
        classMap: {
          "slds-grid": true,
          "slds-wrap": true
        },
        key: 12
      }, api_iterator($cmp.beerRecords, function (item) {
        return api_element("div", {
          classMap: {
            "slds-col": true,
            "slds-size_1-of-3": true
          },
          key: api_key(14, item.Id)
        }, [api_custom_element("c-beer-tile", _cBeerTile, {
          props: {
            "beerRecord": item
          },
          key: 15,
          on: {
            "cart": _m2 || ($ctx._m2 = api_bind($cmp.addToCart))
          }
        }, [])]);
      })) : null])])];
    }
    ...
    tmpl$o.stylesheetTokens = {
      hostAttribute: "lwc-beerList_beerList-host",
      shadowAttribute: "lwc-beerList_beerList"
    };

    const apexInvoker = lds.getApexInvoker("", "BeerController", "searchBeer", false);
    wireService.register(apexInvoker, lds.generateGetApexWireAdapter("", "BeerController", "searchBeer", false));

    var cartIco = `${configProvider$1.getBasePath()}/assets/80f59dd7e1/cart`;

    const apexInvoker$1 = lds.getApexInvoker("", "BeerController", "getCartId", false);
    wireService.register(apexInvoker$1, lds.generateGetApexWireAdapter("", "BeerController", "getCartId", false));

    const apexInvoker$2 = lds.getApexInvoker("", "BeerController", "createCartItems", false);
    wireService.register(apexInvoker$2, lds.generateGetApexWireAdapter("", "BeerController", "createCartItems", false));
    ...
    class BeerList extends navigation.NavigationMixin(lwc.LightningElement) {
      constructor(...args) {
        super(...args);
        this.beerRecords = void 0;
        this.errros = void 0;
        this.cart = cartIco;
        this.cartId = void 0;
        this.itemsinCart = 0;
      ...
      addToCart(event) {
        ...
        const selectBeerRecord = this.beerRecords.find(record => record.Id === selectBeerId);
        /*
    ...
    lwc.registerDecorators(BeerList, {
      wire: {
        wiredRecords: {
          adapter: apexInvoker,
          method: 1
    ...
    var beerList = lwc.registerComponent(BeerList, {
      tmpl: _tmpl$n
    });
