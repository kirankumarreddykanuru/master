Webruntime.moduleRegistry.define('c/dragDrop', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".draggableDiv" + shadowSelector + " {width: 300px;height: 35px;border-radius: 8px;background-color: lightsteelblue;text-align: center;color: black;padding-top: 8px;cursor: move;}\n.lgc-bg" + shadowSelector + " {background-color: rgb(242, 242, 242);}\n.lgc-bg-inverse" + shadowSelector + " {background-color: rgb(22, 50, 92);}\n";
    }
    ...
    **/
    ...
    if (_implicitStylesheets$4) {
      tmpl$7.stylesheets.push.apply(tmpl$7.stylesheets, _implicitStylesheets$4);
    }
    ...
    */
    ...
    if (_implicitStylesheets$3) {
      tmpl$m.stylesheets.push.apply(tmpl$m.stylesheets, _implicitStylesheets$3);
    }
    ...
    * */
    ...
    function tmpl$o($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 6,
        on: {
          "dragstart": _m0 || ($ctx._m0 = api_bind($cmp.dragStart)),
          "dragenter": _m1 || ($ctx._m1 = api_bind($cmp.handleDragEnter)),
          "dragend": _m2 || ($ctx._m2 = api_bind($cmp.handleDragEnd)),
          "dragleave": _m3 || ($ctx._m3 = api_bind($cmp.handleDragleave))
        }
      }, [api_text("Drag me")]), api_element("br", {
        key: 7
      }, []), api_element("div", {
        classMap: {
      ...
      }, []), api_text("Selected File :- "), api_dynamic($cmp.fileName)]), api_element("div", {
        classMap: {
          "slds-p-around_medium": true
        },
        key: 11
        ...
        key: 12,
        on: {
          "click": _m5 || ($ctx._m5 = api_bind($cmp.handleUpload))
        }
      }, [])])])])]), api_custom_element("lightning-layout-item", _lightningLayoutItem, {
        props: {
          "padding": "around-small",
        ...
        attrs: {
          "id": api_scoped_id("dummyId")
        },
        key: 15,
        on: {
          "drop": _m6 || ($ctx._m6 = api_bind($cmp.handleDrop)),
          "dragover": _m7 || ($ctx._m7 = api_bind($cmp.allowDrop))
        }
      }, [api_text("Drop Here")])])])])])];
    }
    ...
    tmpl$o.stylesheetTokens = {
      hostAttribute: "lwc-dragDrop_dragDrop-host",
      shadowAttribute: "lwc-dragDrop_dragDrop"
    };
    ...
    const showToast$1 = (mode = 'dismissable', variant = 'info ', title, message) => {
    ...
    class DragDrop extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.filesUploaded = void 0;
        this.fileName = '';
        this.csvJSON = [];
      }
      ...
      handleUpload(event) {
        ...
        if (!this.filesUploaded) {
          const eventError = showToast$1('dismissable', 'error', 'Select File !!', 'Please Browse your file which contains the role information !!');
    ...
    lwc.registerDecorators(DragDrop, {
      track: {
        fileName: 1,
        csvJSON: 1
      }
    ...
    var dragDrop = lwc.registerComponent(DragDrop, {
      tmpl: _tmpl$n
    });
