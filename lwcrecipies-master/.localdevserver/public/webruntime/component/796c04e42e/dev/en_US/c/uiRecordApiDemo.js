Webruntime.moduleRegistry.define('c/uiRecordApiDemo', ['lwc', 'lightning/configProvider', 'force/lds'], function (lwc, configProvider, lds) { 'use strict';
    ...
    **/
    ...
    function tmpl$3($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 4
      }, [api_text("UI Record API")])])])];
    }

    var _tmpl$4 = lwc.registerTemplate(tmpl$3);
    tmpl$3.stylesheets = [];
    tmpl$3.stylesheetTokens = {
      hostAttribute: "lwc-uiRecordApiDemo_uiRecordApiDemo-host",
      shadowAttribute: "lwc-uiRecordApiDemo_uiRecordApiDemo"
    };

    class UiRecordApiDemo extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(UiRecordApiDemo, {
      publicProps: {
        recordId: {
          config: 0
        }
    ...
    var uiRecordApiDemo = lwc.registerComponent(UiRecordApiDemo, {
      tmpl: _tmpl$4
    });

    return uiRecordApiDemo;
