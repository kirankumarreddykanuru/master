...
import updateMethod from '@salesforce/apex/CustomLookupController.UpdateOwnerId';
export default class Customlookup extends LightningElement {
    ...
    handleSelect(event){
       ...
       updateMethod({
            ...
            AccId: this.recordId,
            OwnerIDs : selectedRecordId
        }).then((result)=>{
            console.log("kiran"+JSON.stringify(result));
        }).catch((error)=>{
            console.log("kumar"+error.body.message);
        })
    }
